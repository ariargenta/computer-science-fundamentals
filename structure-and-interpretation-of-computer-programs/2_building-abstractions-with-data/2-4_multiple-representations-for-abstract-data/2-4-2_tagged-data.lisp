...
(defun real-part (z)
    (cond ((rectangular-p z)
          ...
          (t (error "Unknown type: REAL-PART ~A" z))))
...
(defun imag-part (z)
    (cond ((rectangular-p z)
          ...
          (t (error "Unknown type: IMAG-PART ~A" z))))
...
(defun magnitude (z)
    (cond ((rectangular-p z)
          ...
          (t (error "Unknown type: MAGNITUDE ~A" z))))
...
(defun angle (z)
    (cond ((rectangular-p z)
          ...
          (t (error "Unknown type: ANGLE ~A" z))))
