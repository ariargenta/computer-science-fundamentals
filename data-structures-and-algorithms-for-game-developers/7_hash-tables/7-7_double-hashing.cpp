...
int main(int argc, char** argv) {
    std::cout << "Hash tables - Double hashing example" << std::endl;
    ...
    hashTable.Insert(57, item);

    item = 247;

    hashTable.Insert(68, item);

    item = 456;

    hashTable.Insert(37, item);
    ...
    if(hashTable.Find(82, &item)) {
        std::cout << "Item: 82 has a value of " << item << "." << std::endl;
    }
    else {
        std::cout << "Item 82 not found" << std::endl;
    }

    if(hashTable.Find(37, &item)) {
        std::cout << "Item: 37 has a value of " << item << "." << std::endl;
    }
    else {
        std::cout << "Item: 37 not found" << std::endl;
    }
